...
//        }
    ...
    public boolean initialize() {
        ...
        startservicemonitoring();//서비스가 죽지 않도록 모니터 클래스 실행
...
//        }
    ...
    public void startservicemonitoring(){
        ...
        if(AppSettings.getBgService()) {
            Toast.makeText(getApplicationContext(), "startmonitoring", Toast.LENGTH_SHORT).show();
            ServiceMonitoring.startMonitoring(getApplicationContext());
        } else {
            Toast.makeText(getApplicationContext(), "not monitoring", Toast.LENGTH_SHORT).show();
            ServiceMonitoring.stopMonitoring(getApplicationContext());
        }*/
        //Toast.makeText(getApplicationContext(), "startmonitoring", Toast.LENGTH_SHORT).show();
        ServiceMonitoring.startMonitoring(getApplicationContext());
    }
